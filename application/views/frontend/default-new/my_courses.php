                                    ...
                                    <div class="my-course-1-text pt-1">
                                        ...
                                        <div class="my-course-1-last">
                                            ...
                                            <div class="my-course-1-btn pt-4 me-4">
                                                <?php if($enrolment['expiry_date'] > 0 && $enrolment['expiry_date'] < time()): ?>
                                                    <a class="btn text-14px py-1 text-white" style="background-color: var(--bs-code-color);" href="#" onclick="actionTo('https://fbkonlineservice.co.za/home/handle_buy_now/<?php echo $course_details['id']; ?>')">
